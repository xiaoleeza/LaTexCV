...
\begin{tcolorbox}[top=1mm,bottom=1mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{Skills},box align=top]
	...
	Frameworks and tools I have used (in descending order of familiarity):  \vspace{0.1mm} \\
	{\small
	\textit{Qt5, OpenMP, Git, OpenGL, CUDA, JUCE,  SFML, GTK+, Wwise, Boost, UE4, Unity, Docker}}
\end{tcolorbox} \boxskip
