...
\begin{minipage}{0.72\textwidth}
	...
	\end{minipage}
	\vspace{0.7mm}
	\rule{0.99\textwidth}{1.5pt} %\hspace{1mm}
	\small
...
\begin{tcolorbox}[top=1mm,bottom=1mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{Skills},box align=top]
	...
	Ableton Live		\hfill \bigcircle{symbolcolor} \bigcircle{symbolcolor} \bigcircle{symbolcolor} \bigcircle{symbolcolor} \bigcircle{symbolcolor} \\
	FL Studio		\hfill \bigcircle{symbolcolor} \bigcircle{symbolcolor} \bigcircle{symbolcolor} \bigcircle{symbolcolor} \bigcircle{lightgray}   \\
...
\begin{tcolorbox}[top=1mm,bottom=2.6mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{Interests},box align=bottom]
	\small
	\begin{multicols}{2}
