...
% logo with text
\newcommand*{\logopic}[1]{
    \raisebox{-0.4\baselineskip}{ % negative raisebox lowers the logo
        \includegraphics[
        height=1.26\baselineskip, % logo size
        width=1.26\baselineskip,
        keepaspectratio,
        ]{#1}}
}
...
\begin{tcolorbox}[top=1mm,bottom=1mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{SKILLS},box align=top]
    ...
    {\small \textit{Qt5, OpenMP, Git, OpenGL, CUDA, SFML, GTK+, NumPy, JUCE, Wwise, Boost, UE4, Unity, Docker}}
\end{tcolorbox} \boxskip
...
\begin{tcolorbox}[top=1.25mm,bottom=2.4mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{INTERESTS},box align=bottom]
    \small
    \begin{multicols}{2}
