...
\begin{document}
	...
	\begin{minipage}{0.28\textwidth}
		\raggedleft
		\vspace{-6mm}
		\roundpic[xshift=-2.1cm,yshift=-0.2cm]{3.6cm}{4.6cm}{Jook Joint.png}
	\end{minipage}
		
	\vspace{0.7mm} % space after head section
...
%%%%%%%% INTERESTS %%%%%%%%
\renewcommand{\baselinestretch}{1.15} % make logos a bit bigger since the font is smaller here
\begin{tcolorbox}[top=1mm,bottom=3mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{Interests},box align=bottom]
\small
\begin{multicols}{2}
