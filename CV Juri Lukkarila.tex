...
\newfontfamily\listfont		[Ligatures=TeX]{Myriad Pro SemiCondensed Italic}
\newfontfamily\emphfont		[Ligatures=TeX]{Myriad Pro SemiCondensed Italic}
...
% emphasis font
\newcommand{\myemph}[1]{{\color{black} \emphfont #1}}
...
\definecolor{circcolor}{cmyk}{   1, 0.80, 0,    0} % color of circles etc
\definecolor{boxcolor}	 {cmyk}{0.03, 0.03, 0, 0.08} % box frame
\definecolor{backcolor}  {cmyk}{   0,    0, 0, 0.00} % box background
...
\begin{minipage}[t]{0.638\textwidth}
	...
	\begin{tcolorbox}[top=1mm,bottom=1mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{EDUCATION},box align=top]
		...
		\hspace*{0.25mm} {\Large \textbullet} Major: \myemph{Acoustics \& Audio Technology} \\
		
		\titledate{Bachelor of Science (Technology)}{02/2016}
		\workplace{Aalto University School of Electrical Engineering} \\
		Degree Programme in Electronics and Electrical Engineering \\
		 \hspace*{0.25mm} {\Large \textbullet} Major:  \myemph{Electronics} \hspace{3mm} {\Large \textbullet} Minor:  \myemph{Computer Science} \\
	...
	\begin{tcolorbox}[top=1mm,bottom=1mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{EXPERIENCE},box align=bottom]
		...
		I co-host a two hour radio show \myemph{Ruff Cut} on Finland’s top urban and electronic music radio station \myemph{Bassoradio} every other Thursday evening. \\
...
\begin{tcolorbox}[top=1mm,bottom=1mm,right=1mm,left=1mm,arc=\boxarc,toptitle=\boxtop,bottomtitle=1mm,title=\sectitle{SKILLS},box align=top]
	...
	{\small \textit{Qt5, OpenMP, Git, OpenGL, CUDA, SFML, JUCE, GTK+, Wwise, Boost, UE4, Docker, Unity}}
\end{tcolorbox} \boxskip
